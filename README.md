...
The full technical detail for both platforms is in the sections below, and in
[Using the MCP server from a client](#using-the-mcp-server-from-a-client) further down.
